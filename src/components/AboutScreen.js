                ...
                <div className='w-full lg:w-3/4'>
                    <div className='grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 items-start md:gap-12 gap-8'>
                        ...
                        <div className='bg-blue rounded-[35px] h-100 shadow-2xl p-8 flex flex-col items-center transition-all duration-300 hover:-translate-y-4 cursor-pointer md:mt-16'>
                            ...
                            <p className='text-zinc-300'>Always receiving real-time changes and updating the odds accordingly to give you an accurate experience.</p>
                        </div>
                        ...
                        <div className='rounded-[35px] h-100 shadow-2xl p-8 flex flex-col items-center transition-all duration-300 hover:-translate-y-4 cursor-pointer md:mt-16'>
                            ...
                            <h3 className='text-white text-xl font-semibold px-5 text-center mb-4'>Sourced from Multiple Books</h3>
                            <p className='text-zinc-300'>Collecting the odds from books such as Draft Kings, Fanduel, BetMGM, Barstool, Prize Picks, and so many more!</p>
                        </div>

                        <div className='bg-blue rounded-[35px] h-100 shadow-2xl p-8 flex flex-col items-center transition-all duration-300 hover:-translate-y-4 cursor-pointer md:mt-16'>
                            <img src={Data} className='object-scale-down h-32 w-32 mb-4' alt=''/>
                            <h3 className='text-white text-xl font-semibold px-5 text-center mb-4'>Consistently Perfecting the Model</h3>
                            <p className='text-zinc-300'>The Optimizer is constantly being worked on to guarntee the best possible bets to place.</p>
                        </div>
                    </div>
                </div>
            </div>
